...
<header class="flex items-center mb-3 py-2">
    <div class="flex justify-between items-end w-full">
        <p class="text-muted font-base">
            <a href="/projects" class="text-muted text-sm font-normal no-underline">My Projects</a> / {{ $project->title }}
        </p>
...
<main>
    <div class="lg:flex -mx-3">
        <div class="lg:w-3/4 px-3 mb-6">
            <div class="mb-8">
                <h2 class="text-sm text-muted font-light mb-3">Tasks</h2>
                <!-- {{--tasks--}} -->
            ...
            <div>
                <h2 class="text-sm text-muted font-light mb-3">General Notes</h2>
                <!-- {{--general notes--}} -->
                ...
                <form method="POST" action="{{ $project->path() }}">
                    ...
                    <textarea name="notes" class="card text-default w-full mb-4" style="min-height:200px" placeholder="Anything special that you want to make note of?">{{ $project->notes }}</textarea>
